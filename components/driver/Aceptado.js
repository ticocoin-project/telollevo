...
class Aceptado extends React.Component {
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            <Customheader byeModal={()=>this.volerInicioL()} finalizar="true" verI={this.props.vI}/>
            ...
            rotateEnabled={false}
              >   
                ...
                <Marker
                            ...
                            >
                              <View style={null}>
                              <Image style={styles.markerC} source={marker} />
                            </View>
                    </Marker>
            ...
            <SafeAreaView style={styles.pedidos}>
                ...
                <TouchableOpacity onPress={null} >
                <View style={{alignItems:"center", padding: 20, }}><FontAwesome name="star" style={{ color: "#FF4119", fontSize: 20}} /><Text>Ver Calificación Cliente</Text></View>
                </TouchableOpacity>
            </SafeAreaView>
