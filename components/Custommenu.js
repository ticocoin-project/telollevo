    ...
    return(
      <SafeAreaView style={{flex:1, top: 15}}>
        ...
        <View style={{ padding: 20, borderTopColor: "gray", borderTopWidth: 1, Bottom: 10}} >
            <TouchableOpacity onPress={props.cDriver} style={{ padding: 10, alignItems: "center", justifyContent: "center", borderRadius:20, backgroundColor: "#FF4119", marginBottom: 10}}>
              <Text style={{ fontSize: 20, color: "white", }}>Modo Conductor</Text>
            </TouchableOpacity>
        </View>
      </SafeAreaView>
    )
